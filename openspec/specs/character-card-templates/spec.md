...
#### Scenario: Preview click plays the transition without navigating

- **WHEN** the admin clicks the inline preview card for a character whose theme has a transition
- **THEN** the full covering/uncovering transition animation plays with the character's resolved theme, and the browser does not navigate away from the form

#### Scenario: Preview click with no transition does nothing

- **WHEN** the admin clicks the inline preview card for a character whose theme has no transition
- **THEN** no covering animation plays and the browser does not navigate
